...
import com.example.finalproject.Controller.DetailsController;
...
@WebMvcTest(value = DetailsController.class , excludeAutoConfiguration = {SecurityAutoConfiguration.class})
public class DetailsControllerTest {
    ...
    LocalDateTime localDateTime=LocalDateTime.of(2023,6,20,2,0);
    ...
    void setUp() {
        ...
        detailss = Arrays.asList(details1);
        ...
        reservationDate1=new ReservationDate(null,localDateTime,null,null);
    ...
    void getAllDetailsTest() throws Exception {
        Mockito.when(detailsService.getDetails()).thenReturn(detailss);
        mockMvc.perform(get("/api/v1/details/get-alldetails"))
                .andExpect(status().isOk())
                .andExpect(MockMvcResultMatchers.jsonPath("$", Matchers.hasSize(1)))
                .andExpect(MockMvcResultMatchers.jsonPath("$[0].category").value("inside home"));
    }
